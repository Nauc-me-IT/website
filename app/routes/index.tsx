        ...
        <div className='mx-auto max-w-7xl sm:px-6 lg:px-8'>
          <div className='relative shadow-xl sm:overflow-hidden sm:rounded-2xl'>
            ...
            <div className='lg:pb-18 relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32'>
              <h1 className='text-6xl tracking-tight sm:text-8xl lg:text-9xl text-center font-extrabold'>
                <span className='block font-poppins uppercase text-highlight drop-shadow-md'>Power Metal Stack</span>
              </h1>
              <p className='mx-auto mt-6 max-w-lg text-center text-xl text-highlight sm:max-w-3xl'>
              ...
              <div className='mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center'>
                {user ? (
                  ...
                  <div className='space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0'>
                    ...
                    <Link
                      to='/login'
                      className='bg-yellow-500 hover:bg-yellow-600 flex items-center justify-center rounded-md px-4 py-3 font-medium text-highlight  '
                    >
                      Log In
                    </Link>
                  </div>
